...
import type GestureCommanderPlugin from './main.ts';
        ...
        btn
          ...
          .onClick(async () => {
            this.plugin.settings.cornerAngleThreshold =
              DEFAULT_SETTINGS.cornerAngleThreshold;
            await this.plugin.saveSettings();
            this.plugin.updateGestureCapture();
            this.display();
          })
        ...
        btn
          ...
          .onClick(async () => {
            this.plugin.settings.straightLineTolerance =
              DEFAULT_SETTINGS.straightLineTolerance;
            await this.plugin.saveSettings();
            this.plugin.updateGestureCapture();
            this.display();
          })
    ...
    new Setting(containerEl)
      ...
      .addExtraButton((btn) =>
        btn
          ...
          .setTooltip('Reset to default')
          .onClick(async () => {
            this.plugin.settings.recognitionThreshold =
              DEFAULT_SETTINGS.recognitionThreshold;
            await this.plugin.saveSettings();
            this.display();
          })
      );
