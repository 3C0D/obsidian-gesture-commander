...
export default class GestureCommanderPlugin extends Plugin {
  ...
  private registerGestureEvents(doc: Document): void {
    this.registerDomEvent(
      doc,
      'keydown',
      this.gestureCapture.handleKeyDown as EventListener
    );
    this.registerDomEvent(doc, 'keyup', this.gestureCapture.handleKeyUp as EventListener);
    this.registerDomEvent(
      doc,
      'pointermove',
      this.gestureCapture.handlePointerMove as EventListener,
      true
    );
    this.registerDomEvent(
      doc,
      'pointerdown',
      this.gestureCapture.handlePointerDown as EventListener,
      true
    );
    this.registerDomEvent(
      doc,
      'pointerup',
      this.gestureCapture.handlePointerUp as EventListener,
      true
    );
    this.registerDomEvent(
      doc,
      'contextmenu',
      this.gestureCapture.handleContextMenu as EventListener
    );
  }
